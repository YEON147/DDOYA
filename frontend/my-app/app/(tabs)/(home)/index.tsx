  ...
  return (
    ...
    >
      <View className="px-[18px]">
        ...
        <TodayRoutineHeroCard className="mt-1" timeSlots={timeSlots} isPending={isPending} isError={isError} />
        ...
        <View className="mt-3 gap-5">
          {isPending ? (
            ...
            >
              ...
              {isRefetching && <ActivityIndicator className="mt-3" color={colors.primary} />}
            </Pressable>
          ) : slotCount === 0 ? (
