      ...
      <View className="px-6 pt-2 pb-8" style={{ backgroundColor: colors.background }}>
        <View className="mb-4 rounded-2xl px-4 py-3" style={neuRaised(16, colors.surface)}>
          <View className="flex-row items-center justify-between">
            ...
            >
              <Text className="text-md font-scdream-medium" style={{ color: '#FFFFFF' }}>
                다시찍기
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <View className="mb-4 rounded-2xl px-4 py-3" style={neuRaised(16, colors.surface)} onLayout={handleRegisterInfoLayout}>
          <View className="flex-row items-center justify-between">
            ...
            <Text className="text-sm font-scdream-medium" style={{ color: '#DC2626' }}>
              * 필수 입력
            </Text>
          </View>
          <Text className="mt-1.5 text-sm font-scdream" style={{ color: colors.textMuted }}>
          ...
          {showInputErrors && !alias.trim() ? (
            <Text className="mt-1 text-sm font-scdream" style={{ color: '#DC2626' }}>
              별칭을 입력해 주세요.
            </Text>
          ) : null}
