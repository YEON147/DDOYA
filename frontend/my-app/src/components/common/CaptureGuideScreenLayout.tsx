    ...
    <View className="flex-1" style={{ backgroundColor: colors.background }}>
      ...
      <View className="flex-1 justify-center px-6" style={{ minHeight: 0 }}>
        ...
        >
          ...
          >
            <Text className="text-[12px] font-scdream leading-snug" style={{ color: '#FCFBF8' }} numberOfLines={3}>
              {guideLabel}
            </Text>
          </View>
        </View>
        {Platform.OS === 'web' && webNote ? (
          <Text className="mt-3 text-center text-[12px] font-scdream" style={{ color: colors.textMuted }}>
            {webNote}
          </Text>
        ) : null}
      </View>
