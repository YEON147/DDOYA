...
def generate_report_comments(
    ...
    세부 코멘트 규칙:
    1. excess_comment: 과잉 성분이 있을 경우 위 공통 규칙에 맞춰 초과 정도와 감량 안내. 없으면 "과잉 섭취된 성분이 없어 정말 다행이에요! 건강하게 관리해봐요!"로 짧게 작성.
    ...
    4. schedule_comment: 영양제별 섭취 타이밍 배치 이유(지용성/수용성, 상호작용 등)를 공통 규칙에 맞춰 설명.
